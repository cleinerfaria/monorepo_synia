  ...
  public: {
    Tables: {
      ...
      prescription_item: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'prescription_item_presentation_id_fkey';
            columns: ['presentation_id'];
            isOneToOne: false;
            referencedRelation: 'product_presentation';
            referencedColumns: ['id'];
    ...
    Views: {
      ...
      company_plan_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: 'company_plan_settings_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: true;
            referencedRelation: 'company';
            referencedColumns: ['id'];
      ...
      whatsapp_instance: {
        Row: {
          ...
          status: string;
          updated_at: string | null;
          whatsapp_instance_secret: string | null;
        };
        Insert: {
          access_token?: string | null;
          company_id?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_instance_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: false;
            referencedRelation: 'company';
            referencedColumns: ['id'];
      ...
      whatsapp_contact: {
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_contact_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: false;
            referencedRelation: 'company';
            referencedColumns: ['id'];
      ...
      whatsapp_conversation: {
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_conversation_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: false;
            referencedRelation: 'company';
            referencedColumns: ['id'];
      ...
      page: {
        Row: {
          company_id: string;
          company_database_id: string | null;
          created_at: string | null;
          id: string;
          meta_data: Json | null;
          name: string;
      ...
      page_filter: {
        Row: {
          ...
          company_id: string;
          created_at: string | null;
          has_search: boolean | null;
          id: string;
          label: string | null;
          meta_data: Json | null;
          name: string;
          options_view: string | null;
          order_index: number;
          page_id: string;
        ...
        Relationships: [
          {
            foreignKeyName: 'page_filter_page_id_fkey';
            columns: ['page_id'];
            isOneToOne: false;
      ...
      page_chart: {
        Row: {
          ...
          y_axis_prefix: string | null;
          y_axis_suffix: string | null;
        };
        Insert: {
          active?: boolean | null;
          colors?: string[] | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'page_chart_page_id_fkey';
            columns: ['page_id'];
            isOneToOne: false;
            referencedRelation: 'page';
            referencedColumns: ['id'];
      ...
      whatsapp_session: {
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_session_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: false;
            referencedRelation: 'company';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'whatsapp_session_conversation_id_fkey';
            columns: ['conversation_id'];
            isOneToOne: false;
            referencedRelation: 'whatsapp_conversation';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'whatsapp_session_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'whatsapp_instance';
            referencedColumns: ['id'];
      ...
      whatsapp_session_evaluation: {
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_session_evaluation_session_id_fkey';
            columns: ['session_id'];
            isOneToOne: false;
            referencedRelation: 'whatsapp_session';
            referencedColumns: ['id'];
          },
        ];
      };
      whatsapp_instance_secret: {
        Row: {
          access_token: string;
          company_id: string;
          created_at: string;
        ...
        Relationships: [
          {
            foreignKeyName: 'whatsapp_instance_secret_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: true;
            referencedRelation: 'whatsapp_instance';
            referencedColumns: ['id'];
      ...
      evaluation_instance: {
        ...
        Relationships: [
          {
            foreignKeyName: 'evaluation_instance_evaluation_id_fkey';
          ...
          {
            foreignKeyName: 'evaluation_instance_instance_id_fkey';
            columns: ['instance_id'];
            isOneToOne: false;
            referencedRelation: 'whatsapp_instance';
            referencedColumns: ['id'];
      ...
      evaluation_aspect: {
        ...
        Relationships: [
          {
            foreignKeyName: 'evaluation_aspect_evaluation_id_fkey';
            columns: ['evaluation_id'];
            isOneToOne: false;
            referencedRelation: 'evaluation';
            referencedColumns: ['id'];
      ...
      company_databases: {
        ...
        Relationships: [
          {
            foreignKeyName: 'company_databases_company_id_fkey';
            columns: ['company_id'];
            isOneToOne: false;
            referencedRelation: 'company';
            referencedColumns: ['id'];
...
// Custom exported types for convenience
...
export type PatientIdentifier = Tables<'patient_identifier'>;
...
// Procedure type (temporary interface until types are regenerated)
...
export type PatientIdentifierType = Enums<'patient_identifier_type'>;
export type GenderType = Enums<'gender_type'>;
export type RaceType = Enums<'race_type'>;
...
// =====================================================
// PAGE CHARTS - Gráficos Dinâmicos
// =====================================================

export type PageChartType =
  | 'area'
  | 'line'
  | 'bar'
  | 'pie'
...
export interface PageChartYAxisConfig {
  field: string;
  label: string;
  color?: string;
}
...
export interface PageChart {
  ...
  options_view: string;
  x_axis: string;
  y_axis: PageChartYAxisConfig[];
  colors?: string[];
  show_legend: boolean;
  show_grid: boolean;
  stacked: boolean;
  curve_type?: 'smooth' | 'linear' | 'step';
  x_axis_format?: 'date' | 'datetime' | 'number' | 'currency' | 'auto';
  y_axis_format?: 'number' | 'currency' | 'percent' | 'auto';
...
export type PageChartInsert = Omit<PageChart, 'id' | 'created_at' | 'updated_at'>;
export type PageChartUpdate = Partial<Omit<PageChart, 'id' | 'created_at' | 'updated_at'>>;
