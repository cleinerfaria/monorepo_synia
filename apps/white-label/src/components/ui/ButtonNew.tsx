...
const glowHaloOuter: Record<ButtonNewVariant, string> = {
  ...
  neutral:
    'bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-feedback-neutral-border/32 to-[transparent_65%] dark:from-feedback-neutral-border/25 dark:to-[transparent_65%]',
  danger:
    'bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-feedback-danger-border/38 to-[transparent_65%] dark:from-feedback-danger-border/30 dark:to-[transparent_65%]',
};
...
const glowHaloCore: Record<ButtonNewVariant, string> = {
  ...
  neutral:
    'bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-feedback-neutral-border/22 to-[transparent_62%] dark:from-feedback-neutral-border/16 dark:to-[transparent_62%]',
  danger:
    'bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-feedback-danger-solid/30 to-[transparent_62%] dark:from-feedback-danger-solid/24 dark:to-[transparent_62%]',
};
