...
export type DatePickerDisplayMode = 'long' | 'compact' | 'compactShortYear';
...
export const DatePicker = forwardRef<HTMLInputElement, DatePickerProps>(
  (
    ...
    const formatDisplayDate = (date: Date) => {
      if (displayMode === 'compact') return format(date, 'dd/MM/yyyy');
      if (displayMode === 'compactShortYear') return format(date, 'dd/MM/yy');
