  ...
  return (
    ...
    >
      <span
        aria-hidden
        className={cx(
          'pointer-events-none absolute -inset-8 -z-20 opacity-80 blur-3xl transition-opacity duration-300 group-hover:opacity-100',
      ...
      <span
        aria-hidden
        className={cx(
          'pointer-events-none absolute -inset-4 -z-20 opacity-70 blur-2xl transition-opacity duration-300 group-hover:opacity-95',
          size === 'sm' ? 'rounded-2xl' : size === 'md' ? 'rounded-[22px]' : 'rounded-[26px]',
      ...
      {variant === 'filter' && count > 0 && (
        <span
          className={cx(
            ...
            active
              ? 'bg-primary-500 dark:bg-primary-500 border-primary-400/40 border text-white dark:text-white'
              : 'bg-surface-elevated text-content-secondary dark:bg-surface-elevated dark:text-content-primary border-border/70 border'
          )}
        >
          {count}
        </span>
