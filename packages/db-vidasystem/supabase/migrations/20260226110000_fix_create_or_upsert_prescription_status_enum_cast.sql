...
BEGIN
  ...
  IF v_existing_id IS NOT NULL THEN
    ...
    SET status = COALESCE(v_status_to_apply::public.enum_prescription_status, status),
        notes = p_notes,
  ...
  BEGIN
    ...
    VALUES (
      ...
      p_end_date,
      COALESCE(
        v_status_to_apply::public.enum_prescription_status,
        'draft'::public.enum_prescription_status
      ),
      p_notes,
      p_attachment_url
    )
